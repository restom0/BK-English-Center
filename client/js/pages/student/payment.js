  ...
  $('.prizeModal').click(function (e) {
    ...
    str +=
      `
          ...
          <div>
          <label for="prizeStatus" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` +
      i18n.t('label.status') +
      `</label>
      ...
      `</option>
            <option value="0">` +
      i18n.t('status.not_received') +
      `</option>
            <option value="1">` +
      i18n.t('status.received') +
      `</option>
          </select>
          </div>
      </div>
...
function editPayModal() {
  $('.editPayBtn').click(function (e) {
    ...
    str +=
      ...
      <div>
      <label for="paidStatus" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` +
      i18n.t('label.status') +
      `</label>
