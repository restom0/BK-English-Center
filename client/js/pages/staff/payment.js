...
/** Handle staff prize edit success UI. */
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        str += `
                        ...
                        <div>
                        <label for="payStatus" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">${i18n.t(
                          'label.status'
                        )}</label>
...
/** Submit new salary payment data. */
function addPay() {
