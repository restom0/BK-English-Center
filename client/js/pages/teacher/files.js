  ...
  $('.addBtn').click(function (e) {
    ...
    str +=
      ...
      `</label>
                    ...
                    <div>
                    <label for="bookStatus" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` +
      i18n.t('label.status') +
      `</label>
      ...
      `</option>
                      <option value="-1">` +
      i18n.t('status.not_available') +
      `</option>
                      <option value="0">` +
      i18n.t('status.available') +
      `</option>
                      <option value="1">` +
