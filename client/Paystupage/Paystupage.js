    ...
    if ($('#morePay').text() === i18n.t('action.view_more')) {
      ...
      tempPay.forEach((el, index) => {
        payStr += `<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
            ...
            <span data-edit=${index} data-id=${el['idStudent']} class="studentModal">
                        ${el['name']}
                    </span>
            </th>
            <td class="px-6 py-4">
        ...
        payStr += `
            ...
            <td class="px-6 py-4 flex justify-center">
                <button data-id=${el['idStudent']} data-tooltip-target="notification"
    ...
    if ($('#morePrize').text() === i18n.t('action.view_more')) {
      ...
      tempPrize.forEach((el, index) => {
        ...
        prizeStr += `
            ...
            <td class="px-6 py-4 flex justify-center">
                <button data-id=${el['idStudent']} data-tooltip-target="notification1"
...
function editPay(i, id) {
  $('.submitEditPayBtn').click(function (e) {
    ...
    if (!status || status === '') {
      ...
      Swal.fire({
        title: i18n.t('confirm.title'),
        text: i18n.t('confirm.editing_class', {
          name: tempPay[i]['name'],
...
function deletePay() {
  $('.deletePayBtn').click(function (e) {
    ...
    Swal.fire({
      title: i18n.t('confirm.title'),
      text: i18n.t('confirm.deleting_class', {
