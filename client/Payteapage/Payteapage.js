...
function loadData() {
  ...
  $.ajax({
    type: "get",
    url: API_URL + "/teacherjoinclasses/null-prize",
    headers: {
      Authorization: "Bearer " + localStorage.getItem("apitoken"),
    },
    dataType: "JSON",
  ...
  $(".submitEditPayBtn").click(function (e) {
    ...
    if (!status || status === "") {
      ...
      Swal.fire({
        title: i18n.t('confirm.title'),
        text:
          i18n.t('confirm.editing_teach', {name: tempPay[i]["name"], class: tempPay[i]["className"]}),
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
...
function deletePay() {
  $(".deletePayBtn").click(function (e) {
    ...
    Swal.fire({
      title: i18n.t('confirm.title'),
      text:
        i18n.t('confirm.deleting_teach', {name: tableData[id]["name"], class: tableData[id]["payClass"]}),
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
  ...
  $(".submitEditPrizeBtn").click(function (e) {
    ...
    if (!status || status === "") {
      ...
      Swal.fire({
        title: i18n.t('confirm.title'),
        text:
          i18n.t('confirm.editing_teach', {name: tempPrize[i]["name"], class: tempPrize[i]["className"]}),
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
...
function deletePrize() {
  $(".deletePrizeBtn").click(function (e) {
    ...
    Swal.fire({
      title: i18n.t('confirm.title'),
      text:
        i18n.t('confirm.deleting_teach', {name: tempPrize[id]["name"], class: tempPrize[id]["className"]}),
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
