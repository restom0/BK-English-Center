...
function addWarn() {
  $(".addWarn").click(function (e) {
    ...
    Swal.fire({
      ...
      text:
        i18n.t('confirm.notify_book', {name: tableData[id]["name"]}),
      icon: "warning",
...
function addModal() {
  $(".addBtn").click(function (e) {
    ...
    str += `
                    ...
                    <div>
                        <label for="pay"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` + i18n.t('label.document') + `</label>
                    ...
                    <div>
                        <label for="bookType"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` + i18n.t('label.doc_type') + `</label>
                    ...
                    <div>
                        <label for="bookNums"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` + i18n.t('label.quantity') + `</label>
                    ...
                    <div>
                    <label for="bookStatus" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">` + i18n.t('label.status') + `</label>
