...
const BK_ROUTES = Object.freeze({
  '/': 'pages/public/home/index.html',
  '/home': 'pages/public/home/index.html',
  home: 'pages/public/home/index.html',
  '/courses': 'pages/public/courses/index.html',
  courses: 'pages/public/courses/index.html',
  '/course-detail': 'pages/public/courses-detail/index.html',
  'course-detail': 'pages/public/courses-detail/index.html',
  '/contact': 'pages/public/contact/index.html',
  contact: 'pages/public/contact/index.html',
  '/login': 'pages/auth/login/index.html',
  login: 'pages/auth/login/index.html',
  '/signup': 'pages/auth/signup/index.html',
  signup: 'pages/auth/signup/index.html',
  '/forgot-password': 'pages/auth/forgot-password/index.html',
  'forgot-password': 'pages/auth/forgot-password/index.html',
  '/choose-actor': 'pages/auth/choose-actor/index.html',
  'choose-actor': 'pages/auth/choose-actor/index.html',
  '/my-courses': 'pages/public/my-courses/index.html',
  'my-courses': 'pages/public/my-courses/index.html',
  '/my-page': 'pages/public/my-page/index.html',
  'my-page': 'pages/public/my-page/index.html',
  '/admin': 'pages/admin/dashboard/index.html',
  admin: 'pages/admin/dashboard/index.html',
  '/staff': 'pages/staff/dashboard/index.html',
  staff: 'pages/staff/dashboard/index.html',
  '/stat-financial': 'pages/staff/stat-financial/index.html',
  'stat-financial': 'pages/staff/stat-financial/index.html',
  '/stat-access': 'pages/staff/stat-access/index.html',
  'stat-access': 'pages/staff/stat-access/index.html',
  '/stat-class': 'pages/staff/stat-class/index.html',
  'stat-class': 'pages/staff/stat-class/index.html',
  '/manage-courses': 'pages/staff/manage-courses/index.html',
  'manage-courses': 'pages/staff/manage-courses/index.html',
  '/staff-info': 'pages/staff/profile/index.html',
  'staff-info': 'pages/staff/profile/index.html',
  '/staff-attendance': 'pages/staff/attendance/index.html',
  'staff-attendance': 'pages/staff/attendance/index.html',
  '/staff-pay': 'pages/staff/payment/index.html',
  'staff-pay': 'pages/staff/payment/index.html',
  '/student-info': 'pages/student/profile/index.html',
  'student-info': 'pages/student/profile/index.html',
  '/student-attendance': 'pages/student/attendance/index.html',
  'student-attendance': 'pages/student/attendance/index.html',
  '/student-marks': 'pages/student/marks/index.html',
  'student-marks': 'pages/student/marks/index.html',
  '/student-pay': 'pages/student/payment/index.html',
  'student-pay': 'pages/student/payment/index.html',
  '/teacher-info': 'pages/teacher/profile/index.html',
  'teacher-info': 'pages/teacher/profile/index.html',
  '/teacher-attendance': 'pages/teacher/attendance/index.html',
  'teacher-attendance': 'pages/teacher/attendance/index.html',
  '/teacher-rate': 'pages/teacher/rating/index.html',
  'teacher-rate': 'pages/teacher/rating/index.html',
  '/teacher-pay': 'pages/teacher/payment/index.html',
  'teacher-pay': 'pages/teacher/payment/index.html',
