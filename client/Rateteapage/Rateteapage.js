    ...
    success: function (res) {
      ...
      res.data.forEach((el, index) => {
        ...
        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
            <span class="teacherModal" data-id=${x.id}>
                ${el['name']}
            </span>
        </th>
        <td class="px-6 py-4">
        ...
        <td class="px-6 py-4 ">
            <button data-tooltip-target="cheer" data-email=${x.email} data-id=${index}
...
function loadTeacherModal() {
  $('.teacherModal').click(function (e) {
    ...
    BkSecurity.setSafeHtml($('#teacherModal'), str);
...
function loadRateModal() {
  $('.rateModal').click(function (e) {
    ...
    str += `<div class="col-span-2 mb-5 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <form id="editForm">
            <div class="grid gap-6 mb-6 md:grid-cols-3">
                ...
                <div>
                    <label for="rate"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">${i18n.t('label.rating')}</label>
    ...
    BkSecurity.setSafeHtml($('#rateModal'), str);
